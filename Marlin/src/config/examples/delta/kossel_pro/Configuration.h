...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define  DELTA_CALIBRATION_RADIUS 110.0 
 ...
 */
#define  Z_PROBE_OFFSET_FROM_EXTRUDER -17.25  
...
#define Z_PROBE_ALLEN_KEY
  ...
  // Kossel Pro
  #define  Z_PROBE_ALLEN_KEY_DEPLOY_1_X -105.00 
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Y 0.00
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Z 100.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_FEEDRATE XY_PROBE_SPEED

  #define  Z_PROBE_ALLEN_KEY_DEPLOY_2_X -110.00 
  ...
  #define  Z_PROBE_ALLEN_KEY_DEPLOY_4_X 45.00 
  ...
  #define  Z_PROBE_ALLEN_KEY_STOW_1_X 36.00 
  ...
  #define  Z_PROBE_ALLEN_KEY_STOW_3_X 0.0  
