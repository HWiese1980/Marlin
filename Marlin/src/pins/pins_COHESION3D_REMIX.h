...
//
  ...
  #endif
  #ifndef TMC_SW_MISO
    #define  TMC_SW_MISO     P1_17   
  #endif
  #ifndef TMC_SW_SCK
    #define  TMC_SW_SCK      P1_08   
  #endif
#endif
...
//
#if HOTENDS == 3
  #define  AUTO_FAN_PIN      P1_18   
#else
  #define  AUTO_FAN_PIN      P1_22   
#endif
...
//
  ...
  #undef HEATER_0_PIN
  #define  SPINDLE_LASER_ENABLE_PIN  P2_07   
  #undef HEATER_BED_PIN
  #define  SPINDLE_LASER_PWM_PIN     P2_05   
  #undef FAN_PIN
  #define  SPINDLE_DIR_PIN           P2_06   
#endif
